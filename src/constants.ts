// Google OAuth credentials are intentionally not hardcoded.
// Configure them through VS Code settings or environment variables.
export const OAUTH_CLIENT_ID_ENV = 'AG_SWITCHBOARD_GOOGLE_CLIENT_ID';
